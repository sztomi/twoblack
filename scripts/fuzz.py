...
def test_idempotent_any_syntatically_valid_python(
    src_contents: str, mode: twoblack.FileMode
) -> None:
    ...
    try:
        dst_contents = twoblack.format_str(src_contents, mode=mode)
    except twoblack.InvalidInput:
    ...
    twoblack.assert_equivalent(src_contents, dst_contents)
    twoblack.assert_stable(src_contents, dst_contents, mode=mode)
