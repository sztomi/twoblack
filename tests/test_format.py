...
def check_file(
    subdir: str, filename: str, mode: twoblack.Mode, *, data: bool = True
) -> None:
...
def test_preview_format(filename: str) -> None:
    ...
    check_file(
        "preview",
        filename,
        twoblack.Mode(preview=True, magic_trailing_comma=magic_trailing_comma),
    )
...
def test_python_36(filename: str) -> None:
    ...
    mode = twoblack.Mode(target_versions=PY36_VERSIONS)
...
def test_python_37(filename: str) -> None:
    ...
    mode = twoblack.Mode(target_versions={twoblack.TargetVersion.PY37})
...
def test_python_38(filename: str) -> None:
    ...
    mode = twoblack.Mode(target_versions={twoblack.TargetVersion.PY38})
...
def test_python_39(filename: str) -> None:
    ...
    mode = twoblack.Mode(target_versions={twoblack.TargetVersion.PY39})
    assert_format(source, expected, mode, minimum_version=(3, 9))
...
def test_python_310(filename: str) -> None:
    ...
    mode = twoblack.Mode(target_versions={twoblack.TargetVersion.PY310})
    assert_format(source, expected, mode, minimum_version=(3, 10))
...
def test_python_311(filename: str) -> None:
    ...
    mode = twoblack.Mode(target_versions={twoblack.TargetVersion.PY311})
...
def test_python_2_hint() -> None:
    ...
    exc_info.match(twoblack.parsing.PY2_HINT)
...
def test_power_op_newline() -> None:
    ...
    assert_format(source, expected, mode=twoblack.Mode(line_length=0))
